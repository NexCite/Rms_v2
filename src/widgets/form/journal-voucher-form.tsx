...
export default function JournalVoucherForm(props: Props) {
  ...
  // useEffect(() => {
  //   console.log(props.chartOfAccounts.find((res) => res.id === "4111051"));
  // }, []);
  ...
  const handleSubmit = useCallback(
    ...
    [props.chartOfAccounts, toast.OpenAlert, replace]
  );

  return (
    <form
      className="gap-5 flex flex-col border  max-w-[1500px] m-auto p-5 border-md"
                      ...
                      render={({ fieldState, field }) => {
                        return (
                          <Autocomplete
                            ...
                            isOptionEqualToValue={(e) =>
                              e?.id === value?.reffrence_chart_of_account?.id
                            }
